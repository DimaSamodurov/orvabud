...
Feature: Galleries
  ...
  Scenario: Create Valid Gallery
    ...
    And I fill in "Description" with "This is a test of the first string field"
    And I press "Save"
    Then I should see "'This is a test of the first string field' was successfully added."
    And I should have 1 gallery

  @galleries-invalid @invalid
  Scenario: Create Invalid Gallery (without description)
    When I go to the list of galleries
    And I follow "Add New Gallery"
    And I press "Save"
  ...
  Scenario: Edit Existing Gallery
    Given I have galleries titled "A description"
    When I go to the list of galleries
    And I follow "Edit this gallery" within ".actions"
    Then I fill in "Description" with "A different description"
    And I press "Save"
    Then I should see "'A different description' was successfully updated."
  ...
  Scenario: Create Duplicate Gallery
    ...
    When I go to the list of galleries
    And I follow "Add New Gallery"
    And I fill in "Description" with "UniqueTitleTwo"
    And I press "Save"
